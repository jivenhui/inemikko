...
<div class="form-field">
	...
	<select name="Field_Displays" id="Field_Displays">
			...
			<option value='both'><?php _e("Both", 'ultimate-product-catalogue') ?></option>
	</select>
...
<div class="form-field">
	...
	<select name="Field_Searchable" id="Field_Searchable">
			<option value='No'><?php _e("No", 'ultimate-product-catalogue') ?></option>
			<option value='Yes'><?php _e("Yes", 'ultimate-product-catalogue') ?></option>
	</select>
...
<div class="Info-Div">
		...
		<div class="upcp-full-version-explanation">
				<?php _e("The full version of the Ultimate Product Catalogue Plugin is required to use tags.", 'ultimate-product-catalogue');?><a href="http://www.etoilewebdesign.com/ultimate-product-catalogue-plugin/"><?php _e(" Please upgrade to unlock this page!", 'ultimate-product-catalogue'); ?></a>
		</div>
</div>
<?php } ?>
