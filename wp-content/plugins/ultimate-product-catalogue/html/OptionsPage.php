...
<table id='catalogue-page-display-options-table' class="form-table upcp-options-table">
	...
	<td>
		...
		<label title='Yes'><input type='radio' name='thumb_auto_adjust' value='Yes' <?php if($Thumb_Auto_Adjust == "Yes") {echo "checked='checked'";} ?> /> <span><?php _e("Yes", 'ultimate-product-catalogue')?></span></label><br />
		<label title='No'><input type='radio' name='thumb_auto_adjust' value='No' <?php if($Thumb_Auto_Adjust == "No") {echo "checked='checked'";} ?> /> <span><?php _e("No", 'ultimate-product-catalogue')?></span></label><br />
...
<table id='catalogue-page-functionality-options-table' class="form-table upcp-options-table">
	...
	<td>
		...
		<label title='Yes'><input type='radio' name='clear_all' value='Yes' <?php if($Clear_All == "Yes") {echo "checked='checked'";} ?> /> <span><?php _e("Yes", 'ultimate-product-catalogue')?></span></label><br />
		<label title='No'><input type='radio' name='clear_all' value='No' <?php if($Clear_All == "No") {echo "checked='checked'";} ?> /> <span><?php _e("No", 'ultimate-product-catalogue')?></span></label><br />
	...
	<td>
		...
		<label title='Yes'><input type='radio' name='hide_empty_options' value='Yes' <?php if($Hide_Empty_Options == "Yes") {echo "checked='checked'";} ?> /> <span><?php _e("Yes", 'ultimate-product-catalogue')?></span></label><br />
		<label title='No'><input type='radio' name='hide_empty_options' value='No' <?php if($Hide_Empty_Options == "No") {echo "checked='checked'";} ?> /> <span><?php _e("No", 'ultimate-product-catalogue')?></span></label><br />
...
<div class='upcp-subsection'>
	...
	<div class='upcp-subsection-content'>
		...
		<div class='upcp-option'>
		<?php _e("Show All Label", 'ultimate-product-catalogue')?>
			<fieldset><legend class="screen-reader-text"><span><?php _e("Text that should replace 'Show All' on your catalogue pages", 'ultimate-product-catalogue')?></span></legend>
