				...
				<div class="form-wrap TagDetail">
						...
						<div class="form-field">
								...
								<select name="Field_Displays" id="Field_Displays">
										...
										<option value='both' <?php if ($Field->Field_Displays == "both") {echo "selected=selected";} ?>><?php _e("Both", 'ultimate-product-catalogue') ?></option>
								</select>
								<p><?php _e("Should this field be displayed in any of the main catalogue pages?", 'ultimate-product-catalogue') ?></p>
						</div>
						<div class="form-field">
								...
								<select name="Field_Searchable" id="Field_Searchable">
										<option value='No' <?php if ($Field->Field_Searchable == "No") {echo "selected=selected";} ?>><?php _e("No", 'ultimate-product-catalogue') ?></option>
										<option value='Yes' <?php if ($Field->Field_Searchable == "Yes") {echo "selected=selected";} ?>><?php _e("Yes", 'ultimate-product-catalogue') ?></option>
								</select>
								<p><?php _e("Should this field be searchable in your catalogues?", 'ultimate-product-catalogue') ?></p>
						</div>
						<div class="form-field">
								...
								<select name="Field_Display_Tabbed" id="Field_Display_Tabbed">
										<option value='No' <?php if ($Field->Field_Display_Tabbed == "No") {echo "selected=selected";} ?>><?php _e("No", 'ultimate-product-catalogue') ?></option>
										<option value='Yes' <?php if ($Field->Field_Display_Tabbed == "Yes") {echo "selected=selected";} ?>><?php _e("Yes", 'ultimate-product-catalogue') ?></option>
								</select>
