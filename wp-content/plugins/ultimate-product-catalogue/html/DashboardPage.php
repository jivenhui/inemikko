...
if (isset($_POST['hide_otp_review_box_hidden'])) {update_option('UPCP_Hide_Dash_Review_Ask', sanitize_text_field($_POST['hide_otp_review_box_hidden']));}
...
<?php if ($Ask_Review_Date < time() and  get_option("UPCP_Install_Time") < time() - 3600*24*4) { ?>
<div id='ewd-upcp-review-ask-overlay'></div>
<div class='ewd-upcp-review-ask-popup'>
	<div class='ewd-upcp-review-ask-title'><?php _e('Thank You!', 'ultimate-product-catalogue'); ?></div>
	<div class='ewd-upcp-review-ask-content'>
		<p><?php _e('We wanted to thank the users of our plugins for all of their great reviews recently.', 'ultimate-product-catalogue'); ?></p>
		<p><?php _e('Your positive feedback and constructive suggestions on how to improve our plugins make coming in to work every day worth it for us.', 'ultimate-product-catalogue'); ?></p>
		<p><strong><?php _e("Haven't had a chance to leave a review yet? You can do so at:", 'ultimate-product-catalogue'); ?></strong></p>
		<a href='https://wordpress.org/support/plugin/ultimate-product-catalogue/reviews/' target="_blank" class='ewd-upcp-review-ask-content-link'>Leave a Review!</a>
	</div>
	<div class='ewd-upcp-review-ask-footer-links'>
		<div class='ewd-upcp-hide-review-ask' id="ewd-upcp-hide-review-ask-week" data-askreviewdelay='7'><?php _e('Ask me in a week', 'ultimate-product-catalogue'); ?></div>
		<div class='ewd-upcp-hide-review-ask' id="ewd-upcp-hide-review-ask-never" data-askreviewdelay='2000'><?php _e('Never ask me again', 'ultimate-product-catalogue'); ?></div>
	</div>
</div>
<?php } ?>
...
<div id="ewd-upcp-dashboard-content-area">
	...
	<div id="ewd-upcp-dashboard-content-left">
			...
			<div class="ewd-upcp-dashboard-new-widget-box ewd-widget-box-full">
				<div class="ewd-upcp-dashboard-new-widget-box-top">
					<form method="post" action="admin.php?page=UPCP-options" class="ewd-upcp-dashboard-key-widget">
						...
						<div class="ewd-upcp-dashboard-key-widget-text">Don't have a key? Use the <a href="http://www.etoilewebdesign.com/plugins/ultimate-product-catalog/#buy" target="_blank">Upgrade Now</a> button above to purchase and unlock all premium features.</div>
					</form>
				</div>
			</div>
		<?php } ?>
		...
		<div class="ewd-upcp-dashboard-new-widget-box ewd-widget-box-full" id="ewd-upcp-dashboard-optional-table">
			<div class="ewd-upcp-dashboard-new-widget-box-top">Catalogues<span id="ewd-upcp-dash-optional-table-down-caret">&nbsp;&nbsp;&#9660;</span><span id="ewd-upcp-dash-optional-table-up-caret">&nbsp;&nbsp;&#9650;</span></div>
			<div class="ewd-upcp-dashboard-new-widget-box-bottom">
				<table class='ewd-upcp-overview-table wp-list-table widefat fixed striped posts'>
					<thead>
						<tr>
							...
							<th><?php _e("Products in Catalogue", 'ultimate-product-catalogue'); ?></th>
						</tr>
					</thead>
					<tbody>
						 <?php
		...
		<?php if ($Full_Version != "Yes" or get_option("UPCP_Trial_Happening") == "Yes") { ?>
			<div class="ewd-upcp-dashboard-new-widget-box ewd-widget-box-full" id="ewd-upcp-dashboard-get-premium-widget-box">
				...
				<div class="ewd-upcp-dashboard-new-widget-box-bottom">
					...
					<a href="http://www.etoilewebdesign.com/plugins/ultimate-product-catalog/#buy" class="ewd-upcp-dashboard-get-premium-widget-button" target="_blank">UPGRADE NOW</a>
	...
	<div id="ewd-upcp-dashboard-new-footer-one">
		<div class="ewd-upcp-dashboard-new-footer-one-inside">
			...
			<div class="ewd-upcp-dashboard-new-footer-one-buttons">
				<a class="ewd-upcp-dashboard-new-upgrade-button" href="http://www.etoilewebdesign.com/plugins/ultimate-product-catalog/#buy" target="_blank">UPGRADE NOW</a>
			</div>
		</div>
...
<div id="ewd-upcp-dashboard-new-footer-two">
	<div class="ewd-upcp-dashboard-new-footer-two-inside">
		...
		<ul class="ewd-upcp-dashboard-new-footer-two-menu">
			...
			<li><a href="http://www.etoilewebdesign.com/plugins/ultimate-product-catalogue/documentation-ultimate-product-catalogue/" target="_blank">Documentation</a></li>
